...
describe("Phase 5.6 Design — No Mainnet Adapter", () => {
  it("no mainnet adapter files exist in lib/", () => {
    ...
    for (const f of libFiles) {
      ...
      if (name.includes("ReadOnly") || name.includes("24hShadow") || name.includes("7DayShadow") || name.includes("DryRun") || name.includes("SemiAutoLive") || name.includes("FilledOrder") || name.includes("PositionLifecycle") || name.includes("FundingValidation")) continue;
